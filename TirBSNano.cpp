// ---------------------------------------------------------------------------
// TirBSNano Library - v1.0 - 22/03/2020
// This Library is for the target box with Arduino Nano.
//
// AUTHOR/LICENSE:
...
#include "SoftwareSerial.h"
 ...
 TirBSNano::TirBSNano (int Sensibilite){
...
void TirBSNano::PinSetup() {

}


void TirBSNano::Partie1()
{
    while(1) {   
